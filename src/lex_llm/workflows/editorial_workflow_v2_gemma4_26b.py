"""Editorial workflow v2 Gemma 4 26B cloud version.
...
def get_workflow(request: WorkflowRunRequest) -> Orchestrator:
    return Orchestrator(
        ...
        steps=[
            ...
            generate_source_list_v2(llm_provider=_llm),
        ],
...
def get_metadata() -> dict:
    return {
        "workflow_id": "editorial_workflow_v2_gemma4_26b",
        "name": "Editorial workflow v2 Gemma 4 26B cloud version",
        "status": "active",
        "description": (
